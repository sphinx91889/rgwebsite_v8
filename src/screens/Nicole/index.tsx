...
export const Nicole = (): JSX.Element => {
          ...
          <div className="flex flex-col lg:flex-row items-start gap-12">
            ...
            <div className="w-full lg:w-1/3">
              <div className="relative">
                <img
                  src="https://storage.googleapis.com/msgsndr/8ngdMjJjmckUW3DffAfv/media/681df844aba8ffbf7d3f5752.jpeg"
                  alt="Nicole Hanson"
            ...
            <div className="w-full lg:w-2/3">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-gray-600 mb-6">
                  Nicole Hanson serves as the President and Chief Operating Officer at Riviere Group, where she oversees daily operations and ensures seamless execution across all divisions. With a keen eye for operational excellence and a passion for client success, Nicole has been instrumental in establishing and maintaining the high standards that define Riviere Group's service delivery.
                </p>

                <h3 className="text-xl font-bold mb-4">Role & Responsibilities</h3>
                <ul className="list-disc pl-6 mb-6 space-y-2">
                  <li>Oversees daily operations and team management across all divisions</li>
                  <li>Ensures quality control and service delivery excellence</li>
                  <li>Manages client communications and relationship maintenance</li>
                  <li>Develops and implements operational strategies and processes</li>
                  <li>Coordinates cross-functional team alignment and project execution</li>
                </ul>
                ...
                <div className="bg-blue-50 p-6 rounded-xl mb-8">
                  ...
                  <p className="text-lg text-gray-700 italic">
                    "Success in today's digital landscape requires both precision and adaptability. Our commitment is to deliver excellence through structured processes while remaining agile enough to embrace innovation and meet evolving client needs."
                  </p>
                </div>
