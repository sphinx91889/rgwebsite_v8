...
export const Mevin = (): JSX.Element => {
          ...
          <div className="flex flex-col lg:flex-row items-start gap-12">
            ...
            <div className="w-full lg:w-1/3">
              <div className="relative">
                <img
                  src="https://storage.googleapis.com/msgsndr/8ngdMjJjmckUW3DffAfv/media/6824d3698e57c591c453918c.jpeg"
                  alt="Mevin Riviere-Lee"
            ...
            <div className="w-full lg:w-2/3">
              ...
              <div className="prose prose-lg max-w-none">
                <p className="text-lg text-gray-600 mb-6">
                  Mevin Riviere-Lee is the visionary founder and CEO of Riviere Group, bringing over a decade of experience in digital innovation, music production, and business development. As a veteran and accomplished entrepreneur, Mevin has successfully built multiple ventures and continues to push the boundaries of what's possible in digital media and technology.
                </p>

                <h3 className="text-xl font-bold mb-4">Role & Responsibilities</h3>
                <ul className="list-disc pl-6 mb-6 space-y-2">
                  <li>Sets strategic direction and company vision</li>
                  <li>Leads product development and innovation initiatives</li>
                  <li>Oversees all divisions and major client relationships</li>
                  <li>Drives technological advancement and platform development</li>
                  <li>Spearheads new market opportunities and partnerships</li>
                </ul>

                <h3 className="text-xl font-bold mb-4">Achievements</h3>
                <ul className="list-disc pl-6 mb-6 space-y-2">
                  <li>US Military Veteran</li>
                  <li>RIAA Gold Certified Producer</li>
                  <li>6× Billboard Top #1 Charted</li>
                  <li>Developed multiple successful tech platforms</li>
                  <li>Led projects for major brands and artists</li>
                </ul>

                <div className="bg-blue-50 p-6 rounded-xl mb-8">
                  <h3 className="text-xl font-bold mb-4">Vision Statement</h3>
                  <p className="text-lg text-gray-700 italic">
                    "In today's rapidly evolving digital landscape, success requires more than just technical expertise—it demands innovation, creativity, and a deep understanding of how technology can serve human needs. Our mission is to bridge that gap, creating solutions that don't just meet current demands but anticipate future ones."
                  </p>
                </div>
